...
public class WaiterLogin extends JFrame{
    ...
    //JFrame container
        ...
        LbForm = new JLabel("Waiter Login");
    ...
    class LoginBt implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                String Query1 = "SELECT * FROM waiter WHERE w_Username='"+Fuser+"' and w_Password='"+FSpass+"'";
                ResultSet rs = Dbstmt.executeQuery(Query1);
               
                    //Condition statement for checking username and password
                    if(rs.next()){
                        NewWaiterMenu waiterMenuFrame = new NewWaiterMenu(Fuser);
